...
tokenizer = AutoTokenizer.from_pretrained("category_model_folder_path")

model_cat = DistilBertForSequenceClassification.from_pretrained("category_model_folder_path").to(device)
model_urg = DistilBertForSequenceClassification.from_pretrained("urgency_model_folder_path").to(device)
